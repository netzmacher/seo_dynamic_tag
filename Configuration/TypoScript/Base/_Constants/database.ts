plugin.tx_seodynamictag {
  ...
  # cat=Seo Dynamic Tag - Database*//302;   type=string;          label= Field image*:Name of the field, which contains the flag for an image, which is excluvsive for list views
